const address = "https://michaelgriggs.github.io/TempleInn/json/temples.json";

let billingsTable = document.getElementById('billingsTableBody');

fetch(address)
    .then((response) => response.json())
    .then((jsObject) => {
        //console.log(jsObject);
        billingsTable.innerHTML += `<tr>
