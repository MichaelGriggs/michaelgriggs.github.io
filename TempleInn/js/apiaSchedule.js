let apiaTable = document.getElementById('apiaTableBody');

fetch(address)
    .then((response) => response.json())
    .then((jsObject) => {
        console.log(jsObject);
        apiaTable.innerHTML += `<tr>
        ...
        ;
        document.getElementById('newYears').innerHTML = `${jsObject.closures[0].newyears}`;
        document.getElementById('christmas').innerHTML = `${jsObject.closures[0].christmas}`;
